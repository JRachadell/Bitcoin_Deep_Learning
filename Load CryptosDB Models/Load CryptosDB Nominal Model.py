...
# This file will load TheCryptosDB's nominal model, feel free to play with the parameters of the strategies
...
json_file = open("Nominal_Model/CryptosDB_nominal.json", 'r')
loaded_model_json = json_file.read()
json_file.close()
model = model_from_json(loaded_model_json)
model.load_weights("Nominal_Model/CryptosDB_nominal_weights.h5")
...
# plt.plot(df['Predictions'], label='Prediction')
